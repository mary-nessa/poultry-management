...
@section('title', 'Egg Transfers')

@section('content')
<div class="container mx-auto px-4 py-6" x-data="eggTransferManagement()">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Egg Transfers</h1>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach($eggTransfers as $transfer)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <form action="{{ route('egg-transfers.destroy', $transfer) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this transfer record?')">
                                @csrf
                                @method('DELETE')
    ...
    <div x-show="showCreateModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form action="{{ route('egg-transfers.store') }}" method="POST">
                    @csrf
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">New Egg Transfer</h3>
                        <div class="mb-4">
    ...
    <div x-show="showEditModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form :action="'/egg-transfers/' + editTransferId" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Edit Egg Transfer</h3>
                        <div class="mb-4">
...
@push('scripts')
<script>
function eggTransferManagement() {
    return {
        ...
        async openEditModal(transferId) {
            ...
            try {
                const response = await fetch(`/egg-transfers/${transferId}/edit`);
        ...
        async openShowModal(transferId) {
            try {
                const response = await fetch(`/egg-transfers/${transferId}`);
                const data = await response.json();
