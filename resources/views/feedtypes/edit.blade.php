...
<div class="py-6 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Feed Type</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Feed Type</h3>
            <p class="mt-1 text-sm text-gray-500">Modify an existing feed type.</p>
        </div>
        ...
        <div class="px-4 py-5 sm:p-6">
            <form method="POST" action="{{ route('feedtypes.update', $feedType->id) }}">
                @csrf
                @method('PUT')
